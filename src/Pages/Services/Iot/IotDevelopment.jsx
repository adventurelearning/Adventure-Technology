  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="IoT Development by Adventure Technology"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.adventuretechnology.com/Iot-development"
        />
        <meta
          property="og:image"
          content="https://img.freepik.com/free-photo/futuristic-smart-city-with-5g-global-network-technology_53876-98438.jpg?ga=GA1.1.1569503994.1746852108&semt=ais_hybrid&w=740"
        />
      </Helmet>
      <div>
        <IotHome />
