  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Software Development by Adventure Technology"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.adventuretechnology.com/Software-Development"
        />
        <meta
          property="og:image"
          content="https://img.freepik.com/premium-photo/crm-customer-relationship-management-business-sales-marketing-system-concept_31965-13456.jpg?ga=GA1.1.1569503994.1746852108&semt=ais_hybrid&w=740"
        />
      </Helmet>
