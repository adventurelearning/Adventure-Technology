...
const Locations = () => {
    return (
        <div className="py-20 px-3  bg-gradient-to-br from-gray-900 via-blue-900 to-black text-white">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div className="lg:w-1/2 flex flex-wrap justify-around gap-8">
                    ...
                    <div className="text-center group">
                        ...
                        <p className="text-gray-300 text-sm">No.90, First floor,<br/>
