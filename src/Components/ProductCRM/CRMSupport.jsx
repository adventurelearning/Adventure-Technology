                ...
                <div className="flex flex-col lg:flex-row-reverse">
                    ...
                    <div className="lg:w-1/2 w-full flex flex-col justify-center px-6 sm:px-10 py-8 order-2 lg:order-1">
                        ...
                        <p className="text-base sm:text-lg text-gray-400 leading-relaxed mb-6">
                            Our CRM platform helps you build stronger relationships, streamline workflows, 
                            and unlock growth opportunities. From sales to customer service, 
                            we empower your teams to deliver exceptional customer experiences.
                        </p>
                        ...
                        <div className="border-t border-gray-700 pt-4 mt-2">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <p className="text-gray-400 text-sm sm:text-base">
                                        Automated workflows to increase team efficiency.
                                    </p>
                                </div>
