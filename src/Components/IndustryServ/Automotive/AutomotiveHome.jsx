    ...
    <div className="bg-black text-white">
      <div className='container mx-auto flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden min-h-[80vh] md:min-h-screen'>
        ...
        <div className='text-center relative z-10 max-w-4xl w-full px-4'>
          ...
          <Link to="/Contact">
            <button className='px-6 py-3 sm:px-8 cursor-pointer sm:py-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full font-medium text-base sm:text-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden group'>
