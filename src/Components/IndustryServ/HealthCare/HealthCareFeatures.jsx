...
const HealthCareFeatures = () => {
  ...
  const basicFeatures = [
    ...
    { id: '02', title: 'Appointment Scheduling' },
    { id: '03', title: 'Telemedicine Integration' },
    { id: '04', title: 'Patient Health Records' },
  ];

  const advancedFeatures = [
    { id: '01', title: 'AI-driven Diagnostics' },
    { id: '02', title: 'Health Data Analytics' },
    { id: '03', title: 'Remote Patient Monitoring' },
    { id: '04', title: 'Personalized Treatment Plans' },
  ];
