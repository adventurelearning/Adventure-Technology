      ...
      <div className='container mx-auto flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden min-h-[80vh] md:min-h-screen'>
        ...
        <div className='text-center relative z-10 max-w-4xl w-full px-4'>
          ...
          <h3 className='text-lg sm:text-xl md:text-2xl mb-8 md:mb-10 leading-relaxed opacity-90 animate-fade-in-up'>
            We create secure, scalable healthcare apps that enhance patient care, streamline operations, and improve provider-patient communication.
          </h3>

          {/* Animated button with hover effects */}
           <Link to="/Contact">
            <button className='px-6 py-3 cursor-pointer sm:px-8 sm:py-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full font-medium text-base sm:text-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden group'>
