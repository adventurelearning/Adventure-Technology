  ...
  return (
    <div className="bg-black text-white py-4">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          <h2 className="text-4xl font-semibold text-start mt-16 mb-4">Why Adventure ?</h2>
          <p className="text-lg text-gray-300 w-3/4 text-start">
        ...
        <div className="mb-12">
          <h3 className="text-3xl font-normal text-blue-500 text-center md:text-left ml-5 mb-8">
