        ...
        <div className="flex flex-col lg:flex-row-reverse">
          ...
          <div className="lg:w-1/2 w-full flex flex-col justify-center px-6 sm:px-10 py-8 order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-400 leading-relaxed mb-6">
             Whether it’s order tracking, returns, payments, or shipping updates — our support team ensures every customer enjoys a smooth shopping journey. 
                            We’re here to keep your store running flawlessly while you focus on growing your brand.
            </p>

            <div className="border-t border-gray-700 pt-4 mt-2">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">
                Reliable Customer & Merchant Support
              </h3>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                   Fast help for order issues, refunds, and product queries.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    Tailored support for sellers managing catalogs and logistics.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    Global customer care with localized solutions for every market.
                  </p>
                </div>
              </div>
          ...
          <div className="lg:w-1/2 w-full order-1 lg:order-2">
            <h2 className=" lg:block text-2xl md:text-5xl font-bold text-white leading-tight mb-6 px-6 sm:px-10 lg:px-0">
               Exceptional Support for Shoppers & Sellers
            </h2>
            <img
              src="https://wp.sfdcdigital.com/en-us/wp-content/uploads/sites/4/2024/07/what-is-call-center.jpg?w=1024"
