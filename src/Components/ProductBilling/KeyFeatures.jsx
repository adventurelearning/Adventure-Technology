...
const features = [
  {
    ...
    description: "GST-compliant invoices, multiple payment modes, and instant printing and sharing."
  },
  {
    icon: <IconBox />,
    title: "Inventory & Stock Management",
    description: "Track stock in multiple units, auto updates, and profit/loss reports."
  },
  {
    icon: <IconUsers />,
    title: "Customer & Credit Management",
    description: "Manage credits, settlements, and full customer payment history."
  },
  {
    icon: <IconBarChart />,
    title: "Business Insights & Reports",
    description: "Track profit margins, low-stock alerts, and detailed sales analytics."
  }
];
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-12">
        ...
        <section className="text-left md:text-center">
          ...
          <p className="text-base sm:text-lg text-gray-400 max-w-2xl mx-auto">
            Explore the powerful tools that make our billing software the perfect choice to simplify and grow your business.
          </p>
        </section>
