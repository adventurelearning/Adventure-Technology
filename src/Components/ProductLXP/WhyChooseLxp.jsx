...
// Using inline SVG icons for LXP context
const IconLaptop = () => (
...
const features = [
  { icon: <IconLaptop />, title: "Interactive Learning", description: "Engage learners with modern, device-friendly content anytime, anywhere." },
  { icon: <IconLock />, title: "Secure Access", description: "Protect learner data and provide role-based secure logins." },
  { icon: <IconChart />, title: "Analytics & Insights", description: "Track learner progress, engagement, and outcomes in real-time." },
  { icon: <IconCreditCard />, title: "Flexible Monetization", description: "Enable subscriptions, course bundles, or one-time payments." },
  { icon: <IconShuffle />, title: "Personalized Pathways", description: "Deliver adaptive learning journeys tailored to each learner." },
