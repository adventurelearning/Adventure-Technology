...
const HomeVdo = () => {
  ...
  return (
    <div id="#home" className="relative -top-24 w-full h-3/4 min-h-[690px] md:h-[90vh] lg:h-[85vh] xl:h-[80vh] overflow-hidden text-white">
      {/* Navbar */}
      {/* <div className="relative z-30">
        <Navbar />
      </div> */}

      {/* Light Black Overlay (Full Video) */}
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full md:h-3/4 lg:h-3/4 xl:h-3/4 px-4 sm:px-6 lg:px-8 text-center">
        <div className="text-start md:text-center max-w-6xl mx-auto space-y-4 md:space-y-6 transform transition-all">
          ...
          <div className="pt-15 md:pt-8 lg:pt-8 xl:pt-8 animate-fadeIn delay-200">
            <Link to="/Contact">
              <button className="relative overflow-hidden group bg-blue-600 hover:bg-blue-700 px-8 py-3 md:px-6 md:py-3 rounded-lg text-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 cursor-pointer">
                ...
                {/* Removed glow effect */}
                <span className="absolute -bottom-1 -left-1 -right-1 -top-1 rounded-lg blur-md group-hover:opacity-70 transition-opacity duration-300"></span>
              </button>
            </Link>
          </div>
        </div>
