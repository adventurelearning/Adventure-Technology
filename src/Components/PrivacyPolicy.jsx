      ...
      <div className="max-w-6xl mx-auto bg-gray-900 bg-opacity-70 rounded-xl shadow-2xl overflow-hidden backdrop-blur-sm">
        ...
        <div className="px-8 py-10 sm:px-12 sm:py-12 space-y-8">
          <section id="data-collection">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">1. Data Collection</h2>
          ...
          <section id="data-sharing">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">3. Data Sharing Practices</h2>
            <p className="text-gray-100 leading-relaxed">
          ...
          <section id="security-measures">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">4. Security Measures</h2>
            <p className="text-gray-100 leading-relaxed">
          ...
          <section id="your-rights">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">5. Your Rights</h2>
            <p className="text-gray-100 leading-relaxed">
          ...
          <section id="cookies">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">6. Cookies and Tracking Technologies</h2>
            <p className="text-gray-100 leading-relaxed">
          ...
          <section id="policy-updates">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">7. Updates to This Privacy Policy</h2>
            <p className="text-gray-100 leading-relaxed">
          ...
          <section id="contact-us">
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">8. Contact Us</h2>
            <p className="text-gray-100 leading-relaxed">
              ...
              <br />
              info@adventuretechnologysolutions.com
              <br />
              +91-9840550244
            </p>
          </section>
