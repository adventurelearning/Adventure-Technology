        ...
        <div className="flex flex-col lg:flex-row-reverse">
          ...
          <div className="lg:w-1/2 w-full flex flex-col justify-center px-6 sm:px-10 py-8 order-2 lg:order-1">
            ...
            <h2 className="text-2xl sm:text-3xl hidden lg:text-5xl font-semibold text-white leading-tight mb-6 lg:hidden">
              Reliable Support for Vehicle Tracking
            </h2>
            ...
            <p className="text-base sm:text-lg text-gray-400 leading-relaxed mb-6">
              From easy installation to round-the-clock support, we ensure your vehicles are always tracked and secure. 
              Focus on your business and personal safety — while we take care of the technology.
            </p>

            <div className="border-t border-gray-700 pt-4 mt-2">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4">
                Why Choose Our Vehicle Tracking Support?
              </h3>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    Easy installation & quick setup for any vehicle type.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    Works across India with multi-network SIM support.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    24/7 support for technical and logistics queries.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    Affordable subscription plans with no hidden charges.
                  </p>
                </div>
              </div>         
            </div>
          ...
          <div className="lg:w-1/2 w-full order-1 lg:order-2">
            ...
            {/* In the Box Section */}
            <div className="mt-8">
              <h4 className="text-white font-semibold mb-3">What You Get in the Box</h4>
              <ul className="text-gray-400 text-sm sm:text-base space-y-2 list-disc pl-6">
                <li>GPS Tracker Device</li>
                <li>SIM with Preloaded Data</li>
                <li>Installation Guide</li>
                <li>Access to Dashboard & Mobile App</li>
            ...
            <div className="mt-8">
              <Link to="/Contact">
                <button className="group relative inline-flex items-center justify-center px-6 py-3 text-sm sm:text-base font-medium rounded-lg bg-gradient-to-br from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:focus:ring-indigo-800 transition-all">
                  <span className="relative">Get Vehicle Tracking Support</span>
                </button>
              </Link>
            </div>
          </div>
...
export default VehicleTrackingSupport;
