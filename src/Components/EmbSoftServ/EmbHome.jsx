...
const EmbHome= () => {
    ...
    return (
      <motion.div className="relative w-full bg-gradient-to-br from-black via-gray-900 to-blue-950 overflow-hidden">
  ...
  <div className="relative z-10 flex flex-col items-center justify-center px-6 sm:px-12 mt-12">
    <div className="text-center space-y-6 sm:space-y-8 max-w-5xl mx-auto">
      <h1 className="text-4xl sm:text-5xl lg:text-5xl font-semibold text-white tracking-tight mt-15">
        Embedded Software & ML Solutions for Smarter, 
        <span className="block mt-4">Data-Driven Decisions</span>
      </h1>
      <h3 className="text-lg text-gray-300 mx-auto mt-10">
        We build intelligent, scalable systems that leverage to automate processes, uncover insights, and drive innovation.
      </h3>
      <motion.div
