        ...
        <div className="bg-black py-12">
            <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="text-center md:text-left md:w-1/2 space-y-6">
                    ...
                    >
                        Embedded Product <span className="block text-blue-400">Design Services</span>
                    </motion.h1>
                    <motion.h3
                        initial={{ opacity: 0, x: -50 }}
                        animate={{ opacity: 1, x: 0 }}
                    ...
                    >
                        Building Intelligent Hardware Solutions Tailored to Your Product Vision
                    </motion.h3>
                    <motion.div
                    ...
                    >
                        ...
                        >
                            Request a Free Consultation <span className="pl-3"><i className="bi bi-arrow-right"></i></span>
                        </button>
                    </motion.div>
                    <motion.p
                        initial={{ opacity: 0, x: -50 }}
                    ...
                    >
                        We design and build embedded systems that drive innovation — from initial concept to final product. Our expertise spans hardware development, firmware engineering, and IoT integration for industries ranging from healthcare to industrial automation.
                    </motion.p>
                </div>
