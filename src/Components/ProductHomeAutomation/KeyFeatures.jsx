...
const features = [
  {
    ...
    description: "Manage lights, fans, ACs, and more through a mobile app or voice assistant."
  },
  {
    icon: <IconBox />,
    title: "Voice Control Compatibility",
    description: "Works seamlessly with Alexa, Google Assistant, and Siri for hands-free operation."
  },
  {
    icon: <IconUsers />,
    title: "Smart Scheduling",
    description: "Automate daily routines—turn on lights at sunset, set AC timers, and more."
  },
  {
    icon: <IconBarChart />,
    title: "Remote Access",
    description: "Monitor and control your home devices from anywhere using your smartphone."
  }
];
