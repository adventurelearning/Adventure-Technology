...
import homeauto from '../../assets/homeauto1 (2).jpg';
import { Link } from 'react-router-dom';
import { HashLink } from "react-router-hash-link";
const HomeAutomationHome = () => {
  return (
    <div className=" bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <div className="mx-auto px-6 md:pl-16 py-12 ">
        <div className="flex flex-col md:flex-row items-center md:items-start">
          ...
          <div className="md:w-2/4 mb-12 md:mb-0 md:mt-26 text-left md:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight mb-6">
              Smart {" "}
              <span className="text-blue-500">Home Automation Platform </span>{" "}
              for Smarter Living
            </h1>
            <p className="text-lg sm:text-xl text-gray-400 mb-8">
              Control Devices | Secure Your Home | Live Comfortably
            </p>
...
export default HomeAutomationHome;
