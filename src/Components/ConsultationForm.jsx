            ...
            <div className=" min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative  overflow-hidden">
                <div className="relative z-10 w-full max-w-6xl">
                    <motion.div
                        ...
                        className="lg:grid lg:grid-cols-2 bg-black bg-opacity-70 backdrop-blur-lg rounded-2xl overflow-hidden border border-gray-800 "
                    >
                        {/* Left Content */}
                        <div className="text-white p-6 sm:p-10 md:p-12 flex flex-col justify-center bg-gradient-to-br from-blue-900/30 to-black/50 relative">
                        ...
                        {/* Right Form */}
                        <div className="bg-gray-950 p-2 sm:p-5 md:p-12 lg:p-12 xl:p-12 flex items-center justify-center">
                            <motion.div
